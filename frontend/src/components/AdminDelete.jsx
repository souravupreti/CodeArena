          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold font-mono text-gray-900">
                DELETE <span className="text-rose-600">PROBLEMS</span>
              </h1>
              <p className="text-xs text-gray-500 font-mono">Remove problems permanently from CodeArena</p>
            </div>
          </div>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-gray-200 bg-gray-50/80 font-mono text-[11px] text-gray-500 font-semibold uppercase">
                  ...
                  <th className="py-3.5 px-5 w-40">TAGS</th>
                  ...
                  <tr key={problem._id} className="hover:bg-gray-50/80 transition-colors">
                    ...
                    <td className="py-3.5 px-5 text-center">
                      <button 
                        ...
                        className="px-3 py-1 rounded-md bg-rose-600 hover:bg-rose-700 text-white font-mono text-xs font-semibold shadow-2xs transition-all cursor-pointer inline-flex items-center gap-1"
                      >
                        <Trash2 size={13} />
                        Delete
                      </button>
